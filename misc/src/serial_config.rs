...
impl PortConfig {
    ...
    /// Получение списка файлов конфигурации
    pub fn get_existing_config_names() -> Result<Vec<String>, String> {
    ...
    pub fn save_config_into_file(&self, name: &str) -> Result<(), String> {
    ...
    pub fn load_config_from_file(&mut self, name: &str) -> Result<(), String> {
        let mut config_instance = Ini::new();
